    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-heading font-bold text-aires-navy mb-6 animate-fade-up">
            Empowering Data-Driven Financial Solutions
          </h1>
          <p className="text-lg md:text-xl text-aires-gray mb-8 max-w-2xl mx-auto animate-fade-up">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 rounded-lg bg-white shadow-lg">
              <Shield className="w-12 h-12 text-aires-emerald mb-4" />
            ...
            <div className="p-6 rounded-lg bg-white shadow-lg">
              <Zap className="w-12 h-12 text-aires-emerald mb-4" />
            ...
            <div className="p-6 rounded-lg bg-white shadow-lg">
              <BarChart2 className="w-12 h-12 text-aires-emerald mb-4" />
