      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="grid grid-cols-1 gap-8 h-full">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 shadow-lg transform hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
          ...
          <div className="grid grid-cols-1 gap-8 h-full">
            ...
            <div className="relative flex flex-col h-full">
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-xl p-8 shadow-lg transform hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
